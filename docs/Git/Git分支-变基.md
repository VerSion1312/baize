...
![将 C4 中的修改变基到 C3 上。](./_media/basic-rebase-3.png)
...
![master 分支的快进合并。](./_media/basic-rebase-4.png)
...
![从一个主题分支里再分出一个主题分支的提交历史。](./_media/interesting-rebase-1.png)
...
![截取主题分支上的另一个主题分支，然后变基到其他分支。](./_media/interesting-rebase-2.png)
...
![快进合并 master 分支，使之包含来自 client 分支的修改。](./_media/interesting-rebase-3.png)
...
![将 server 中的修改变基到 master 上。](./_media/interesting-rebase-4.png)
...
![最终的提交历史。](./_media/interesting-rebase-5.png)
...
![克隆一个仓库，然后在它的基础上进行了一些开发。](./_media/perils-of-rebasing-1.png)

图9. 克隆一个仓库，然后在它的基础上进行了一些开发 ▲

然后，某人又向中央服务器提交了一些修改，其中还包括一次合并。 你抓取了这些在远程分支上的修改，并将其合并到你本地的开发分支，然后你的提交历史就会变成这样：

![抓取别人的提交，合并到自己的开发分支。](./_media/perils-of-rebasing-2.png)

图10. 抓取别人的提交，合并到自己的开发分支 ▲

接下来，这个人又决定把合并操作回滚，改用变基；继而又用 `git push --force` 命令覆盖了服务器上的提交历史。 之后你从服务器抓取更新，会发现多出来一些新的提交。

![有人推送了经过变基的提交，并丢弃了你的本地开发所基于的一些提交。](./_media/perils-of-rebasing-3.png)

图11. 有人推送了经过变基的提交，并丢弃了你的本地开发所基于的一些提交 ▲

结果就是你们两人的处境都十分尴尬。 如果你执行 `git pull` 命令，你将合并来自两条提交历史的内容，生成一个新的合并提交，最终仓库会如图所示：

![你将相同的内容又合并了一次，生成了一个新的提交。](./_media/perils-of-rebasing-4.png)
...
![在一个被变基然后强制推送的分支上再次执行变基。](./_media/perils-of-rebasing-5.png)
